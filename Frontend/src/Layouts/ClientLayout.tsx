...
// Define main navigation links for client
const navLinks = [
  { link: "/client", label: "Dashboard", icon: IconDashboard },
  { link: "/client/appointments", label: "Appointments", icon: IconCalendar },
  { link: "/client/appointments/new", label: "Create Appointment", icon: IconNotes },
];

const footerLinks = [
  { link: "/client/profile", label: "Profile", icon: IconUserCircle },
];
